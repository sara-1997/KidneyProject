...
public class ListWishFortVolunteerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_wish_fort_volunteer);
        initialfirebase();
        getallWish();
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    ...
                    if(post.getStatus().equals("Wait"))
                        ListWish.add(post);
                    if(post.getStatus().equals("Accept")&&post.getVolunteerId().equals(UserId))
                        ListWish.add(post);


                }
                AdapterWish adapter = new AdapterWish(ListWish , ListWishFortVolunteerActivity.this,UserType);
