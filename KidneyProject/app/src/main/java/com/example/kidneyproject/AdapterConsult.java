...
public class AdapterConsult extends RecyclerView.Adapter<AdapterConsult.AdapterNotholder>{
    private final String UserId;
    java.util.List<Consult> List;
    Context context ;
    String UserType;
    ...
    public AdapterConsult(List<Consult> listConsult, Context context, String userType) {
    ...
    @NonNull
    @Override
    public AdapterConsult.AdapterNotholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_notification_list, parent, false);
        AdapterConsult.AdapterNotholder adapterHolder = new AdapterConsult.AdapterNotholder(v);
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterConsult.AdapterNotholder holder, final int position) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                ...
                                intent.putExtra("Activity", "Consult");
                            ...
                            case 1:
                                DatabaseReference updateData = FirebaseDatabase.getInstance()
                                        .getReference("Consult")
                                        .child(List.get(position).getKey());
                                updateData.removeValue();
                                Toast.makeText(context,"Delete Consult  Successfully",Toast.LENGTH_LONG).show();
                                context.startActivity(new Intent(context,ListConsultActivity.class));
